...
class ZipTests: XCTestCase {
    ...
    func testImplicitProgressZip() throws {
        ...
        // url이 제대로된 URL을 만들어주지 않음
        //let imageURL1 = url(forResource: "3crBXeO", withExtension: "gif")!
        //let imageURL2 = url(forResource: "kYkLkPf", withExtension: "gif")!
        let imageURL1 = URL(fileURLWithPath: "/Users/khj-mac/downloads/Zip-master/ZipTests/Resources/3crBXeO.gif")
        let imageURL2 = URL(fileURLWithPath: "/Users/khj-mac/downloads/Zip-master/ZipTests/Resources/kYkLkPf.gif")
        //let zipFilePath = sandboxFolder.appendingPathComponent("archive.zip")
        let sandboxFolder = "/Users/khj-mac/desktop/무제 폴더/아카이브2.zip"

        progress.becomeCurrent(withPendingUnitCount: 1)
        try Zip.zipFiles(paths: [imageURL1, imageURL2], zipFileLocationWithName: sandboxFolder, password: nil, progress: nil)
        progress.resignCurrent()
